...
export async function saveService(
  ...
  const payload = {
    ...
    priceType: String(formData.get("priceType") ?? "quote"),
    setupPriceMin: num(formData.get("setupPriceMin")),
    setupPriceMax: num(formData.get("setupPriceMax")),
    monthlyPrice: num(formData.get("monthlyPrice")),
    currency: String(formData.get("currency") ?? "TRY"),
    priceNoteTr: String(formData.get("priceNoteTr") ?? ""),
    priceNoteEn: String(formData.get("priceNoteEn") ?? ""),
